        ...
        <div className="service-providers-display-card">
          ...
          <div className="service-providers-display-card-about">
            ...
            <div className="service-providers-display-card-about-rounded-div">
              ...
              <div style={{ height: "10px" }}></div>
              <div>
                I grew up with a mom who had OCD so we cleaned until there
                wasn't a speck of dust left! I am efficient in my cleanings and
                also know the importance of getting every crevice (especially
                with COVID). AirBnB experience. I have all the cleaning supplies
              </div>
            ...
            <div className="service-providers-display-card-review">
              ...
              <div className="service-providers-display-card-review-review">
                ...
                <div className="service-providers-display-card-review-review-review">
                  "Nya was on time, had a great personality, and did a wonderful
                  job getting my showers,glass and floors clean. Would use again
                  for sure. "
                </div>
              </div>
            </div>
